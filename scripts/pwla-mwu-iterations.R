...
# Same as the non-withiterations version (pwla-util.R),
# but with added functionality for generating sl1 data for different subsets of data.
# The iterations list is used to get different DRoC values using the subset functions from pwla.R.
