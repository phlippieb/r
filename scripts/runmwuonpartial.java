...
Note:
This only prints all the cat commands that are needed to stitch partial mwu together.
Take the output of this class and run it from the r base dir
...
class runmwuonpartial {
	...
	public static void main (String [] args) {
		...
		for (int a1=0; a1<algorithms.length-1; a1++) {
